...
pub const Dropout = pad.Dropout;
pub const Noise = pad.Noise;
pub const Perceive = pad.Perceive;
pub const ZOrder = pad.ZOrder;
...
pub const ExclusiveOr = logic.ExclusiveOr;
